import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { z as prefixStorage, A as useStorage, B as useNitroOrigin, C as emojiCache, D as useOgImageRuntimeConfig, c as createError, E as fetchIsland, F as createHeadCore, G as normaliseFontInput, H as withTrailingSlash, g as getQuery, I as handleCacheHeaders, J as setHeaders, a as setHeader, K as hash, L as parseURL, M as setResponseHeader, N as proxyRequest, O as sendRedirect, P as resolveContext, Q as H3Error } from '../nitro/nitro.mjs';
import { renderSSRHead } from '@unhead/ssr';

const theme = {"fontFamily":{"spacegrotesk":["Space Grotesk","sans-serif"]},"colors":{"primary":{"50":"#eff6ff","100":"#dbeafe","200":"#bfdbfe","300":"#93c5fd","400":"#60a5fa","500":"#3b82f6","600":"#2563eb","700":"#1d4ed8","800":"#1e40af","900":"#1e3a8a"},"accent":{"50":"#fdf4ff","100":"#fae8ff","200":"#f5d0fe","300":"#f0abfc","400":"#e879f9","500":"#d946ef","600":"#c026d3","700":"#a21caf","800":"#86198f","900":"#701a75"}},"animation":{"fade-in":"fadeIn 0.6s ease-out","slide-up":"slideUp 0.6s ease-out","slide-down":"slideDown 0.6s ease-out","bounce-gentle":"bounceGentle 2s ease-in-out infinite","glow":"glow 2s ease-in-out infinite alternate","float":"float 3s ease-in-out infinite","pulse-slow":"pulse 3s cubic-bezier(0.4, 0, 0.6, 1) infinite"},"screens":{"xs":"475px","sm":"640px","md":"768px","lg":"1024px","xl":"1280px","2xl":"1536px"},"keyframes":{"fadeIn":{"0%":{"opacity":"0"},"100%":{"opacity":"1"}},"slideUp":{"0%":{"transform":"translateY(20px)","opacity":"0"},"100%":{"transform":"translateY(0)","opacity":"1"}},"slideDown":{"0%":{"transform":"translateY(-20px)","opacity":"0"},"100%":{"transform":"translateY(0)","opacity":"1"}},"scaleIn":{"0%":{"transform":"scale(0.9)","opacity":"0"},"100%":{"transform":"scale(1)","opacity":"1"}},"bounceGentle":{"0%, 100%":{"transform":"translateY(0)"},"50%":{"transform":"translateY(-5px)"}},"float":{"0%, 100%":{"transform":"translateY(0px)"},"50%":{"transform":"translateY(-10px)"}},"glow":{"0%":{"boxShadow":"0 0 5px rgba(59, 130, 246, 0.5)"},"100%":{"boxShadow":"0 0 20px rgba(59, 130, 246, 0.8)"}}},"backgroundImage":{"gradient-radial":"radial-gradient(var(--tw-gradient-stops))","gradient-conic":"conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))"},"backdropBlur":{"xs":"2px"}};
