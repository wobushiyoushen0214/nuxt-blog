...
import { resolve as resolve$2, dirname, join } from 'node:path';
...
function createNodeFetch() {
  ...
  const httpAgent = new O.Agent(agentOptions);
  const httpsAgent = new I.Agent(agentOptions);
...
const _assets = {
  ["nuxt-og-image:fonts:Inter-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2025-09-18T03:20:23.727Z"}
  },
  ["nuxt-og-image:fonts:Inter-700.ttf.base64"]: {
    import: () => import('../raw/Inter-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2025-09-18T03:20:23.727Z"}
  },
  ["nitro:bundled:cache:content:content-index.json"]: {
    import: () => import('../raw/content-index.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"2a3-DzUlVs3xuxd3kO/5a99diNvNTR8\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"332-vneWO6VjnaWUNTM5fe35wKGaqN8\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blogs:1. connect-namecheap-to-vercel.md"]: {
    import: () => import('../raw/1. connect-namecheap-to-vercel.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"1551-YUVXjopqpcoHosAOnv7gD6z2m6o\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blogs:2. fix-tailwindcss-intellisense-in-nuxt3.md"]: {
    import: () => import('../raw/2. fix-tailwindcss-intellisense-in-nuxt3.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"1413-z+jOzJ6pwgUf9/Q8dMS20TvrVBQ\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blogs:3. create-namespace-subdomain-connect-to-vercel.md"]: {
    import: () => import('../raw/3. create-namespace-subdomain-connect-to-vercel.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"1280-ZDqpP88VIBIkiItQyi1N1SsRQTg\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blogs:4. fetch-content-data-render-pages.md"]: {
    import: () => import('../raw/4. fetch-content-data-render-pages.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"172a-gOdokbWEvMPfI8bByKwgjF4JJdw\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blogs:5. vue3-awesome-library.md"]: {
    import: () => import('../raw/5. vue3-awesome-library.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"1830-wxNu0Oro2fWavLm9aGHG3NMvl0c\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blogs:6. how-to-fix-vuex-type-issue.md"]: {
    import: () => import('../raw/6. how-to-fix-vuex-type-issue.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"a12-ZWoP58TNb8+4sr3ybYMHBHFlyXk\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blogs:7. cactus.md"]: {
    import: () => import('../raw/7. cactus.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"a6f-3m5LRyiwgqoQq1mjqpCKwPyfN90\"","mtime":"2025-09-18T03:20:47.702Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blogs:8. kotlin.md"]: {
    import: () => import('../raw/8. kotlin.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"c1a-ZkGQs1MHNUAW8D1fG2hVv7C2I1s\"","mtime":"2025-09-18T03:20:47.702Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "5e918c1c-d726-437b-bd8a-c54e93d28405",
  ...
  "nuxt-og-image": {
    ...
    "debug": false,
    "baseCacheKey": "/cache/nuxt-og-image/3.1.1",
    "fonts": [
      {
        "cacheKey": "Inter:400",
        "style": "normal",
...
const _MGznd4tGXo_b2XStXDIUa84kI7CjUTiR7AMAWGcTU = defineNitroPlugin(async (nitroApp) => {
...
const _zNG4waqPb9fuWsD7ZAl4LXGYzxRoqyiL1vH6pRdE = defineNitroPlugin(async (nitroApp) => {
...
const _xI4x9ql_UMTH_UesUuu7JNY6B9vopro2D1fB1jqXo = defineNitroPlugin((nitroApp) => {
...
const _A4E5KkUwrxkMiMeX1XN3x_m0rRWgpu_CY2BmJJctHU = defineNitroPlugin((nitroApp) => {
...
const _XGsCm1XVT0nFGJ4Jc4PyUtPlCczIi4fcAsFDac7ek = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _eFbSfTF03UKHHtcFDhaf7YIbfEz62Gctrl1WT72IWts = (function(nitro) {
...
const plugins = [
  _MGznd4tGXo_b2XStXDIUa84kI7CjUTiR7AMAWGcTU,
_zNG4waqPb9fuWsD7ZAl4LXGYzxRoqyiL1vH6pRdE,
_xI4x9ql_UMTH_UesUuu7JNY6B9vopro2D1fB1jqXo,
_A4E5KkUwrxkMiMeX1XN3x_m0rRWgpu_CY2BmJJctHU,
_XGsCm1XVT0nFGJ4Jc4PyUtPlCczIi4fcAsFDac7ek,
_eFbSfTF03UKHHtcFDhaf7YIbfEz62Gctrl1WT72IWts
];

const _voVLv5 = eventHandler(async (e) => {
...
const _mcQ93Q = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _V4U5SI = defineEventHandler(async (e) => {
...
const _JCOQaL = defineEventHandler(async (e) => {
  const content = [];
  try {
...
function normaliseEntry(_e, defaults, resolvers) {
  ...
  if (e.alternatives) {
    ...
    for (let i = 0; i < alternatives.length; i++) {
      ...
      if (typeof alt.href === "string") {
        alt.href = resolve$1(alt.href, resolvers);
      } else if (typeof alt.href === "object" && alt.href) {
        alt.href = resolve$1(alt.href.href, resolvers);
      }
    }
  ...
  if (e.images) {
    ...
    for (let i = 0; i < images.length; i++) {
      images[i].loc = resolve$1(images[i].loc, resolvers);
    }
  ...
  if (e.videos) {
    ...
    for (let i = 0; i < videos.length; i++) {
      if (videos[i].content_loc) {
        videos[i].content_loc = resolve$1(videos[i].content_loc, resolvers);
      }
    }
...
async function fetchDataSource(input, event) {
  ...
  try {
    ...
    if (isExternalUrl) {
      ...
      logger$1.error("Failed to fetch external source.", errorInfo);
    } else {
      logger$1.error("Failed to fetch source.", { url, error: error.message });
    }
    return {
      ...input,
      context,
...
const _QvKAjB = defineEventHandler(async (e) => {
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width,initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"你好，我是Li。一名软件工程师，专注于前端开发和 Web 技术。"},{"name":"format-detection","content":"telephone=no"},{"name":"theme-color","content":"#ffffff"},{"name":"msapplication-TileColor","content":"#ffffff"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"},{"rel":"manifest","href":"/site.webmanifest"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width,initial-scale=1","title":"Li's Blog | Li博客","titleTemplate":"%s - Li's Blog | Li博客"};
...
const _kegmCq = defineEventHandler(async (event) => {
...
const _8g_PTF = defineEventHandler(async (event) => {
...
const _mbM0Pi = defineEventHandler(async (event) => {
  const { getContentQuery } = await import('../_/query.mjs');
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _TQuMjB = lazyEventHandler(() => {
...
const _lazy_2vAngP = () => import('../routes/api/search.get.mjs');
const _lazy_ChDorX = () => import('../routes/rss.xml.mjs');
const _lazy_OkXoKX = () => import('../routes/renderer.mjs');
const _lazy_ICXJgt = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_XL9G7X = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/search', handler: _lazy_2vAngP, lazy: true, middleware: false, method: "get" },
  { route: '/rss.xml', handler: _lazy_ChDorX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_OkXoKX, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _voVLv5, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _mcQ93Q, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _V4U5SI, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/nuxt-content.json', handler: _JCOQaL, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _NXelz6, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _cUqXX2, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _QvKAjB, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_ICXJgt, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_XL9G7X, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_XL9G7X, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _kegmCq, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _kegmCq, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _kegmCq, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1758165623729.json', handler: _8g_PTF, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _mbM0Pi, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _mbM0Pi, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _mbM0Pi, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _TQuMjB, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_OkXoKX, lazy: true, middleware: false, method: undefined }
];
...
export { baseURL as $, useStorage as A, useNitroOrigin as B, emojiCache as C, useOgImageRuntimeConfig as D, fetchIsland as E, createHeadCore as F, normaliseFontInput as G, withTrailingSlash as H, handleCacheHeaders as I, setHeaders as J, hash as K, parseURL as L, setResponseHeader as M, proxyRequest as N, sendRedirect as O, resolveContext as P, H3Error as Q, useRuntimeConfig as R, generateTitle as S, defu as T, headSymbol as U, isScriptProtocol as V, withQuery as W, useServerHead as X, useHead as Y, sanitizeStatusCode as Z, getContext as _, setHeader as a, resolveUnrefHeadInput as a0, createHooks as a1, withBase as a2, destr as a3, executeAsync as a4, toRouteMatcher as a5, createRouter$1 as a6, withoutBase as a7, withLeadingSlash as a8, withoutTrailingSlash as a9, decodeHtml as aa, logger as ab, toBase64Image as ac, htmlDecodeQuotes as ad, fontCache as ae, encodeParam as af, encodePath as ag, parseQuery as ah, klona as ai, defuFn as aj, getRequestHeader as ak, isEqual as al, setCookie as am, getCookie as an, deleteCookie as ao, listener as ap, appId as b, createError$1 as c, defineEventHandler as d, defineRenderHandler as e, buildAssetsURL as f, getQuery as g, appTeleportTag as h, appTeleportAttrs as i, createSSRContext as j, appHead as k, setSSRError as l, getRouteRules as m, getRenderer as n, getEntryIds as o, publicAssetsURL as p, hasProtocol as q, renderInlineStyles as r, serverQueryContent as s, relative as t, joinURL as u, replaceIslandTeleports as v, useNitroApp as w, getResponseStatusText as x, getResponseStatus as y, prefixStorage as z };
