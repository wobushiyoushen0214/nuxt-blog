import { ai as klona, aj as defuFn } from '../nitro/nitro.mjs';
import { g as qo, z as Io } from './server.mjs';

const s = defuFn(Io({ nuxtIcon: { size: "1em", class: "", aliases: {}, iconifyApiOptions: { url: "https://api.iconify.design", publicApiFallback: true } } }), { nuxt: {} });
function l() {
  const o2 = qo();
  return o2._appConfig || (o2._appConfig = klona(s)), o2._appConfig;
}
...
function a(i2 = "") {
  ...
  if ("@" === i2[0] && i2.includes(":") && (e2 = i2.split(":")[0].slice(1), i2 = i2.split(":").slice(1).join(":")), i2.startsWith("i-")) {
    i2 = i2.replace(/^i-/, "");
    for (const e3 of c) if (i2.startsWith(e3)) {
...
export { a, l };
//# sourceMappingURL=index-BF41Y92k.mjs.map
